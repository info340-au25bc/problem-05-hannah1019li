...
const oldMottoLength = mottoLength;
const newMottoLength = motto.length;
const ratio = ((newMottoLength / oldMottoLength) * 100).toFixed(2) + "%";
console.log(ratio);
